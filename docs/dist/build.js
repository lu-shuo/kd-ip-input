...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dist_kd_ip_input_esm__ = __webpack_require__(15);




__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].use(__WEBPACK_IMPORTED_MODULE_2__dist_kd_ip_input_esm__["a" /* default */]);
...
var getBuiltIn$2 = function (namespace, method) {
  return arguments.length < 2 ? aFunction(path$2[namespace]) || aFunction(global$h[namespace]) : path$2[namespace] && path$2[namespace][method] || global$h[namespace] && global$h[namespace][method];
};
...
var script = {
  ...
  watch: {
    ...
    ipList(newVal) {
      ...
      // 添加前缀
      ip = this.showPrefix && this.prefix ? this.prefix + '://' + tempList.join('.') : tempList.join('.');
      // 添加端口
  ...
  methods: {
    ...
    init(ip) {
      ...
      if (this.showPrefix) {
        ...
        if (ip.indexOf(this.prefix) !== -1) {
          ip = ip.split(/(http|https|wss|ws):\/\//).slice(-1)[0].trim();
        }
      }
      // 带端口，分离端口
      if (this.showPort) {
      ...
      for (let i = 0, length = tempList.length; i < length; i++) {
        ...
        if (isNaN(segment) || segment < 0 || segment > 255) {
          console.info('%c[kd-ip-input]：输入ip范围不合法，已默认恢复至0', 'color: red');
    ...
    handleInput(e, index) {
      ...
      // 满三位向右跳转
      if (!this.showPort && value.length === 3 && index < 3 || this.showPort && value.length === 3 && index < 4) {
    ...
    handleKeyDown(e, index) {
      ...
      if (keyCode === 8 || keyCode === 37) {
        if ((value.length === 0 || getCursorPosition(e.target).end === 0) && index > 0) {
          this.$refs.ipInput[index - 1].focus();
        }
      }
      // 39-右方向键
      // 光标在最右边，光标向右边input跳转
      if (keyCode === 39) {
        if (getCursorPosition(e.target).end === value.length && (!this.showPort && index < 3 || this.showPort && index < 4)) {
          this.$refs.ipInput[index + 1].focus();
        }
      }
      // 32-空格，13-回车 向右跳转
      if ((keyCode === 32 || keyCode === 13) && (!this.showPort && index < 3 || this.showPort && index < 4)) {
        this.$refs.ipInput[index + 1].focus();
      }
    },
    handleBlur() {
...
var __vue_render__ = function () {
  ...
  return _c("div", { staticClass: "kd-ip-input-group" }, [_vm.showPrefix ? _c("div", { staticClass: "kd-ip-input-group__prepend" }, [_vm._v(_vm._s(_vm._f("prefixFormat")(_vm.prefix)))]) : _vm._e(), _vm._v(" "), _c("ul", {
    ...
    }), _vm._v(" "), index < 3 ? _c("div", { staticClass: "kd-ip-input-group__dot" }) : _vm._e(), _vm._v(" "), _vm.ipList.length === 5 && index === 4 ? _c("div", { staticClass: "kd-ip-input-group__colon" }, [_c("div", { staticClass: "dot" }), _vm._v(" "), _c("div", { staticClass: "dot" })]) : _vm._e()]);
  }), 0)]);
};
...
const __vue_component__ = /*#__PURE__*/normalizeComponent({ render: __vue_render__, staticRenderFns: __vue_staticRenderFns__ }, __vue_inject_styles__, __vue_script__, __vue_scope_id__, __vue_is_functional_template__, __vue_module_identifier__, false, undefined, undefined, undefined);
