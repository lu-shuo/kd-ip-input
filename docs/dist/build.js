...
!function (t, n) {
  ...
  var t = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
    ...
    return arguments.length < 2 ? X(Y[t]) || X(K[t]) : Y[t] && Y[t][n] || K[t] && K[t][n];
      ...
      tt = Z && Z.v8;tt && (j = (P = tt.split("."))[0] > 0 && P[0] < 4 ? 1 : +(P[0] + P[1])), !j && H && (!(P = H.match(/Edge\/(\d+)/)) || P[1] >= 74) && (P = H.match(/Chrome\/(\d+)/)) && (j = +P[1]);var nt = j,
      et = nt,
      it = b,
    ...
    return "Symbol(" + (void 0 === t ? "" : t) + ")_" + zt(++Nt + Ft, 36);
      ...
      Ht = lt,
      Jt = function (t, n) {
    var e = t[n];return null == e ? void 0 : vt(e);
  },
      Qt = function (t, n) {
    ...
    if (t = gn(t), n = bn(n), yn) try {
      ...
      xn = /#|\.prototype\./,
      kn = function (t, n) {
    var e = jn[Pn(t)];return e == Sn || e != On && (_n(n) ? wn(n) : !!n);
  },
    ...
    return function (n, e, i, r) {
      fe(e);var o = he(n),
        ...
        if (s in u) {
          r = u[s], s += a;break;
        }if (s += a, t ? s < 0 : p <= s) throw ve("Reduce of empty array with no initial value");
      }for (; t ? s >= 0 : p > s; s += a) s in u && (r = e(r, u[s], s, o));return r;
    };
  },
      me = { left: ye(!1), right: ye(!0) },
      we = b,
    ...
    return je[t + "Prototype"];
      ...
      this.init(this.value);
        ...
        const t = this.ipList;let n;if (t.every(t => "" !== t)) {
          const e = t.slice(0, 4);n = this.showPrefix && this.prefix ? this.prefix + "://" + e.join(".") : e.join("."), n = this.showPort ? n + ":" + t[4] : n;
        } else n = "";return n;
      }, handleInput(t, n) {
        ...
        const e = t.keyCode,
              i = t.target.value;8 !== e && 37 !== e || (0 === i.length || 0 === Oe(t.target).end) && n > 0 && this.$refs.ipInput[n - 1].focus(), 39 === e && Oe(t.target).end === i.length && (!this.showPort && n < 3 || this.showPort && n < 4) && this.$refs.ipInput[n + 1].focus(), 32 !== e && 13 !== e || !(!this.showPort && n < 3 || this.showPort && n < 4) || this.$refs.ipInput[n + 1].focus();
      }, handleBlur() {
        this.$nextTick(() => {
          if (-1 === document.activeElement.className.indexOf("kd-ip-input-group__input-inner")) {
            ...
            });const t = this.genIp();this.$emit("blur", t);
          }
        });
